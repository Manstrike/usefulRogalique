...
INSERT INTO `days` (`id_days`, `name_days`, `num`) VALUES
	(8, 'Monday', 1),
	(9, 'Tuesday', 2),
	(10, 'Wednesday', 3),
	(11, 'Thursday', 4),
...
-- Дамп данных таблицы shedulerdb.group_list: ~0 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `notif_config` time DEFAULT NULL,
  `last_send` varchar(50) DEFAULT NULL,
...
-- Дамп данных таблицы shedulerdb.user: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id_users`, `name`, `chatID`, `group_code`, `notif_config`, `last_send`, `subscribe`) VALUES
	(22, 'AlexDark', '204521174', 4, '01:05:00', '2019-03-15 1:05:00 1:05:00', 1);
